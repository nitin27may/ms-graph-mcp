...
def test_allowlist_count_is_stable():
    # 42 read tools across 9 Graph domains — a regression guard so adding or
    # dropping a tool is a deliberate edit rather than an accident.
    assert len(READ_TOOL_NAMES) == 42
